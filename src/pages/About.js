...
export default function About(props) {
	...
	const matchesXL = useMediaQuerry(theme.breakpoints.down("xl"));
			...
			>
				<Grid item>
					<Lottie
						...
						height={"100%"}
						width={"100%"}
						// height={matchesXS ? "95%" : matchesSM ? "55%" : matchesXL ? "20%" : "85%"}
						// width={matchesXS ? "95%" : matchesSM ? "55%" : matchesXL ? "20%" : "85%"}
					/>
				</Grid>
				<Grid item>
